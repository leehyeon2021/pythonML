...
train_input , test_input , train_target , test_target = train_test_split(iris_length, iris_weidth, test_size=0.3, random_state=42)
...
print( lr.score( test_input , test_target ))    # 테스트 결정계수   : 0.5423687498422736
print( lr.score( train_input , train_target ))  # 훈련 결정계수    : 0.5395298831723283
print( lr.coef_ )                               # 기울기          : [0.76182638]
print( lr.intercept_ )                          # 절편            : -0.3876310655937556
